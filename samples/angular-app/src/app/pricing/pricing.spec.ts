import { formatCents, PriceCalculator, TierDiscount, type Order } from './pricing';
...
describe('PriceCalculator', () => {
  ...
  it('caps the discount', () => {
    expect(new PriceCalculator([new TierDiscount()], 5).totalCents(order({ tier: 'gold' }))).toBe(9_500);
  });
